...
<link href="static/h-ui/css/H-ui.min.css" rel="stylesheet"
	type="text/css" />
<link href="static/h-ui.admin/css/H-ui.admin.css" rel="stylesheet"
	type="text/css" />
<!--[if IE 6]>
	...
	<section class="container-fluid page-404 minWP text-c">
		...
		<p class="error-info">
			您可以： <a href="javascript:;" onclick="history.go(-1)"
				class="c-primary">&lt; 返回上一页</a> <span class="ml-20">|</span> <a
				href="${pageContext.request.contextPath }/index.jsp" class="c-primary ml-20">去首页 &gt;</a>
		</p>
	</section>
</body>