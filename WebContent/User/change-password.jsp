...
<body>
	<article class="page-container">
		<form action="${pageContext.request.contextPath }/user_changeWord.action?user_id=${model.user_id}" method="post" class="form form-horizontal"
			id="form-change-password" target="_parent">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
					class="c-red">*</span>账户：</label>
				<div class="formControls col-xs-8 col-sm-9">${model.trueName }</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
